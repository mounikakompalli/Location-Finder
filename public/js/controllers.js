angular.module("LocationFinder.controllers",['LocationFinder.services']).controller("LocationSearchController",['$scope','$location','LocationFinderAppService',function($scope,$location,LocationFinderAppService){
